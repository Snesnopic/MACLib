...
void CMACApp::LoadFont()
{
    ...
    if (hUser32 != APE_NULL)
    {
        BOOL(STDAPICALLTYPE * pSystemParametersInfoForDpi) (IN UINT uiAction, IN UINT uiParam, PVOID pvParam, IN UINT fWinIni, IN UINT dpi);
    ...
    m_nFontHeight = -ncm.lfMessageFont.lfHeight;
}
