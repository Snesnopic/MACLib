...
CString CAPEInfoFormatDlg::GetSummary(const CString & strFilename)
{
    ...
    else
    {
        ...
        CSmartPtr<CInputSource> spInputSource(CInputSource::CreateInputSource(strFilename, &wfeInput, &nTotalBlocks, &nHeaderBytes, &nTerminatingBytes, &nFlags, APE_NULL, &nErrorCode));
